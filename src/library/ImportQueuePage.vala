...
public class ImportQueuePage : SinglePhotoPage {
    ...
    private void connect_signal_handlers(BatchImport batch_import) {
    ...
    private void disconnect_signal_handlers(BatchImport batch_import) {
    ...
    public void enqueue_and_schedule(BatchImport batch_import, bool allow_user_cancel) {
        ...
        connect_signal_handlers(batch_import);
    ...
    private void update_stop_action() {
        set_action_sensitive(
            "Stop",
            !cancel_unallowed.contains(current_batch) && queue.size > 0
        );
    }
    ...
    private void on_import_complete(BatchImport batch_import, ImportManifest manifest,
        ...
        disconnect_signal_handlers(batch_import);
