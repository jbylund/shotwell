...
public abstract class Photo : PhotoSource, Dateable, Positionable {
    ...
    public void set_title_persistent(string? title) throws Error {
        ...
        stderr.printf("Reading metadata from %s in Photo.set_title_persistent:2450\n", source.get_filepath());
    ...
    public void set_comment_persistent(string? comment) throws Error {
        ...
        stderr.printf("Reading metadata from %s in Photo.set_comment_persistent:2478\n", source.get_filepath());
        PhotoMetadata metadata = source.read_metadata();
    ...
    public void set_exposure_time_persistent(time_t time) throws Error {
        ...
        stderr.printf("Reading metadata from %s in Photo.set_exposure_time_persistent:2522\n", source.get_filepath());
        PhotoMetadata metadata = source.read_metadata();
    ...
    public override PhotoMetadata? get_metadata() {
        try {
            stderr.printf("Reading metadata from source_reader in Photo.get_metadata:2689\n");
    ...
    public PhotoMetadata get_master_metadata() throws Error {
        stderr.printf("Reading metadata from Photo.get_master_metadata:2699\n");
        return get_master_reader().read_metadata();
    }

    public PhotoMetadata? get_editable_metadata() throws Error {
        PhotoFileReader? reader = get_editable_reader();
        stderr.printf("Reading metadata from Photo.get_editable_metadat:2705\n");
